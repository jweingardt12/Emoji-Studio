// This script tests the fixed normalizeSlackCurl function

// Import the fixed normalizeSlackCurl function
const { normalizeSlackCurl } = require("../lib/utils/normalize-slack-curl-fixed.js")
...
// Generate canonical curl command using the fixed function
const canonicalCurl = normalizeSlackCurl(testCurl)
console.log("\nFixed canonical curl:\n", canonicalCurl)
