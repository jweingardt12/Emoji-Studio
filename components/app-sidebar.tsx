...
// FeedbackModal is now imported from the shared component
...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    <Sidebar collapsible="offcanvas" {...props}>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Link
                    ...
                    className={cn(
                      "flex items-center justify-center gap-2 rounded-md px-3 py-2.5 text-sm font-medium",
      ...
      {feedbackModalOpen && <FeedbackModal open={feedbackModalOpen} onClose={() => setFeedbackModalOpen(false)} currentPage={pathname} />}
    </Sidebar>
  );
}
