...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-x-0 bottom-0 z-50 flex h-auto flex-col rounded-t-[10px] border bg-background max-h-[60vh] overflow-hidden",
    ...
    >
      ...
      <div className="sticky top-0 z-10 bg-background rounded-t-[10px] pb-2">
