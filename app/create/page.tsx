...
function EmojiCreatorPage() {
  ...
  useEffect(() => {
    setIsClient(true)
    openpanel.track("Emoji Creator: Page Viewed")
  }, [])
                  ...
                  <CardContent>
                    <div className="grid gap-6 md:grid-cols-3">
                      ...
                      <div className="space-y-2">
                        ...
                        <h3 className="font-medium">3. Download & Use</h3>
                        <p className="text-sm text-muted-foreground">
                          Download your perfectly formatted emojis individually or all at once. They're ready to upload directly to your Slack workspace!
                        </p>
                      </div>
                    </div>
                  </CardContent>
